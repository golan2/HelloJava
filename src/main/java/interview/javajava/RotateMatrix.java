...
public class RotateMatrix {
  ...
  private static String matrixToString(int[][] matrix) {
    ...
    for (int row = 0; row < matrix.length; row++) {
      for (int col = 0; col < matrix[row].length; col++) {
        buf.append(matrix[row][col]).append(", ");
      }
      buf.append("\n");
    }
    return buf.toString();
   ...
   * In order to actually rotate the ring we call {@link #rotateRing(int[][], interview.javajava.RotateMatrix.Ring)}
   ...
   * You rotate the corners by calling {@link #rotate4points(int[][], interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point)}
   ...
   *  And again we call {@link #rotate4points(int[][], interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point, interview.javajava.RotateMatrix.Point)}
